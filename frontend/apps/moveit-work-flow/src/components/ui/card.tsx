...
const cardVariants = cva('rounded-xl border text-card-foreground transition-all duration-200', {
    variants: {
        variant: {
            ...
            glass: 'backdrop-blur-xl border-border/50 bg-card/70',
            interactive: 'bg-card border-border shadow-card hover:border-primary/50 hover:shadow-glow cursor-pointer',
